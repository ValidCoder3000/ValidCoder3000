...
![MY IMAGE BANNER CONTAINING MY NAME](./assets/picture1.png)
...
I see coding as writing the computer's story in order to yield results. I know my coding journey is far from over, and I look forward to what lies ahead.
...
<ins>My Stats</ins>
* HTML: 50% accuracy
* JavaScript: 30% accuracy
* Java: 25% accuracy
* Markdown: 60% accuracy
